 ...
 * +page), so SvelteKit passes the 101 through untouched. One origin behind
 * Cloudflare Access ⇒ the CF_Authorization cookie rides the upgrade; we verify
 * the owner here BEFORE forwarding to the DO (§13).
 */
